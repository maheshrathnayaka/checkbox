...
public class Selection extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Select four");

        jCheckBox1.setText("Choice 01");
        ...
        jCheckBox2.setText("Choice 02");

        jCheckBox3.setText("Choice 03");

        jCheckBox4.setText("Choice 04");

        jCheckBox5.setText("Choice 05");

        jCheckBox6.setText("Choice 06");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(count<=4 && count!=0) {
            JOptionPane.showMessageDialog(rootPane, "Send to Database");
            System.out.println(count);
        }else{
            JOptionPane.showMessageDialog(rootPane, "Error Handling");
            System.out.println(count);
        }
